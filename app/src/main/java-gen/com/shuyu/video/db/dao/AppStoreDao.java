...
/** 
 * DAO for table "AppStore".
*/
public class AppStoreDao extends AbstractDao<AppStore, Long> {

    public static final String TABLENAME = "AppStore";

    /**
     * Properties of entity AppStore.<br/>
    ...
    */
    ...
    public AppStoreDao(DaoConfig config) {
        super(config);
    }
    
    public AppStoreDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"AppStore\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"AppStore\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, AppStore entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, AppStore entity) {
        stmt.clearBindings();
    ...
    @Override
    public AppStore readEntity(Cursor cursor, int offset) {
        AppStore entity = new AppStore( //
    ...
    @Override
    public void readEntity(Cursor cursor, AppStore entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(AppStore entity, long rowId) {
        entity.setAppId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(AppStore entity) {
        if(entity != null) {
