...
public class LiveVideoData {
    ...
    private List<NightVideoDetail> nightVideoDetailList;
    ...
    public List<NightVideoDetail> getNightVideoDetailList() {
        return nightVideoDetailList;
    }

    public void setNightVideoDetailList(List<NightVideoDetail> nightVideoDetailList) {
        this.nightVideoDetailList = nightVideoDetailList;
    }

    public static class NightVideoDetail {
        private int id;
